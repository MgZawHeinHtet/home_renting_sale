<x-agent-dashboard-layout>
    <div class="w-[85%]">
        ...
        <div class="border mt-10 px-10 py-10 rounded-lg">
            <p class="text-gray-500 font-bold  tracking-wide ">You can use the Credits when making your advertisements featured posts. Featured posts get more than 7 times of views than normal posts. The more Credits you buy, the more discount you will get.</p>
        </div>
