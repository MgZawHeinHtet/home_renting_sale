<x-agent-dashboard-layout>
    <div class="w-[540px] bg-home-900 mx-auto shadow-sm px-6 py-4 rounded-lg">
        ...
        <div class="space-y-3 py-5">
            ...
            <div class="flex gap-1">
                <h4 class="w-[150px]  tracking-wide text-white">Transaction Price </h4>
            ...
            <div class="flex gap-2">
                ...
                <form action="/adminAgents/transcation/{{ $transcation->id }}/wrong" method="POST">
                    @csrf
                    <button class="px-6 py-3 bg-red-600 rounded-lg text-white">Wrong Transaction</button>
                </form>
                @else
                    <p class="text-orange-600 tracking-wide">You {{ $transcation->status }}ed this transaction.</p>
                @endif
            </div>
            <div class="pt-5">
                <img class="w-full  rounded-lg" src="{{ $transcation->transcation_photo }}" alt="">
            </div>
