            ...
            <div class="relative py-3 sm:max-w-xl sm:mx-auto">
                ...
                <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div class="max-w-md mx-auto">
                        <div>
                            <h1 class="text-3xl text-home-600 font-semibold">Signup Form</h1>
                        </div>
                        <x-error name="error"></x-error>
                        <div class="divide-y divide-gray-200">
                            <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                                <div class="relative">
                                    <input value="{{ old('name') }}" autocomplete="off" id="name" name="name"
                                        type="text"
                                ...
                                <div class="relative">
                                    <input value="{{ old('email') }}" autocomplete="off" id="email" name="email"
                                        type="text"
                                        class="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                                ...
                                <div class="relative">
                                    <input autocomplete="off" id="password" value="{{ old('password') }}"
